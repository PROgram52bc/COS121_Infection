...
void Human::draw() {
	...
	if (isAlive()) {
		...
		cout << conio::bgColor(conio::BLACK);
...
/**
 * @brief heals the human
 */
void Human::heal() { infected = false; } 

/**
 * @brief reports whether this human is alive.
 * @return whether this human object is alive.
 */
bool Human::isAlive() const { return Alive; }

/**
 * @brief kills the human.
 */
void Human::setDead() { Alive = false; } 
